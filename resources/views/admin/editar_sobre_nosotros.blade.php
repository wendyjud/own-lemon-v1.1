...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="card-group" style="margin-top:2%">
            <div class="card mb-3 " >
                <img src="../resources/imagenes/image.JPG" class="card-img-top rounded-circle mx-auto d-block" alt="..." style="width: 150px; margin-top:2%;">
                <div class="card-body">
                <h5 class="card-title text-center">Nuestros Valores</h5>
                <p class="card-text">1. Somos innovadores por naturaleza
                2. Somos lideres fuera de serie
                3. Estamos comprometidos con nuestros clientes</p>
                </div>
            </div>
            <div class="card mb-3">
                <img src="../resources/imagenes/image.JPG" class="card-img-top rounded-circle mx-auto d-block" alt="..." style="width: 150px;  margin-top:2%;">
                ...
                <p class="card-text">Transformar la agricultura a través de la transferencia de conocimientos, tecnologías, productos y servicios, con el fin de asegurar la producción sostenible de alimentos y la salud de la población.</p>
                </div>
            </div>
            <div class="card">
                <img src="../resources/imagenes/image.JPG" class="card-img-top rounded-circle mx-auto d-block" alt="..." style="width: 150px;  margin-top:2%;">
                ...
                <p class="card-text">Ser líderes en capacitación e innovación agrícola a nivel Latinoamérica; provocando un mejor nivel de vida en el sector, siempre con un compromiso social y de respeto al ambiente.</p>
                </div>
            </div>
        </div>
